      ...
      >
        ...
        >
          ...
          <div className="flex flex-wrap gap-4 pt-6">
            <button onClick={() => document.location='https://expo.dev/artifacts/eas/97KLPnNfLQPk4rSVe9Q6XP.apk'} className="flex items-center gap-2 bg-[#24924B] text-white px-6 py-3 rounded-md font-semibold hover:scale-105 transition-transform duration-300 shadow-md">
              <Download className="w-5 h-5" />
              Download Now
            </button>
            <button onClick={() => document.location='https://www.youtube.com/watch?v=3zl-Vu-lecY'} className="flex items-center gap-2 border border-[#24924B] text-[#24924B] px-6 py-3 rounded-md font-semibold hover:bg-[#E8F6EF] transition">
